...
namespace ToyTwoToolbox {
    ...
    public class UIA {
        ...
        public bool preventDecrease = false;
        public bool preventIncrease = false;
        ...
        public int Increment(int Value = 0) {
            ...
            if (Reversed && CycleOffset == 0 || !Reversed && CycleOffset == CycleTime) {
                ...
                if (!preventIncrease && !Reversed || !preventDecrease && Reversed) {
                    CycleOffset += Value;
                }
            }
            return CycleOffset;
